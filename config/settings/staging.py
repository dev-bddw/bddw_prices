...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["bddwsalestools.com"])
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "bddw_prices.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "bddw_prices.utils.storages.MediaRootS3Boto3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="bddw prices <noreply@bddwsalestools.com>",
)
...
LOGGING = {
    ...
    "formatters": {
        "aws": {
            "format": "%(asctime)s [%(levelname)-8s] %(message)s %(name)s [%(pathname)s:%(lineno)d]",
            "datefmt": "%Y-%m-%d %H:%M:%S",
        },
    },
    "handlers": {
