...
./react_views/r_price_lists/templates/r_price_lists/pricelist/build.sh
./react_views/r_price_lists/templates/r_price_lists/pricelist_print/build.sh
./react_views/r_price_lists/templates/r_price_lists/pricelist_print_gbp/build.sh
