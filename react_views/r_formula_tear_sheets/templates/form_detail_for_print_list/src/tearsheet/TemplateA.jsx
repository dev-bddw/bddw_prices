  ...
  return(
		<>
			<tr key={index} className="hover:bg-gray-50 text-gray-400 text-left">
				{
				edit_type ?
					<td style={{'width': `${sdata.col_1}px`}}><input onChange={ (event) => onChangeHandler(event,setRecord)} className={classes} value={ index == 0 ? rule_type : null}></input></td>
				...
				edit_list ?
					...
					<td style={{'display': 'none', 'width':`${sdata.col_4}px`}}></td>
			</tr>
		</>
	)
}
