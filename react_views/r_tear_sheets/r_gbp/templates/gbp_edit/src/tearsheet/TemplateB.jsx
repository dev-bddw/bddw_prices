  ...
  return(
		<>
			<tr key={index} className="hover:bg-gray-50 text-gray-400 text-left">
				...
				edit_two ?
					<td style={{'width':`${sdata.col_3}%`}}><input onChange={ (event) => onChangeHandler(event,setTwo)} className={classes} value={display_two}></input></td>
				...
				{
				edit_listNoVat ?
					<td style={{'width':`${sdata.col_5}%`}}><input onChange={ (event) => onChangeHandler(event,setListNoVat)} className={SETTINGS.input_classes} value={listNoVat}></input></td>
					:<td style={{'width':`${sdata.col_5}%`}} onClick={ () => { onClickHandler(setEditListNoVat)} } >£{listNoVat}</td>
				}
				{
				edit_trade ?
					<td style={{'width':`${sdata.col_6}%`}}><input onChange={ (event) => onChangeHandler(event,setTrade)} className={SETTINGS.input_classes} value={trade}></input></td>
					:<td style={{'font-weight': 'bold', 'width':`${sdata.col_6}%`}} onClick={ () => { onClickHandler(setEditTrade)} } >£{trade}</td>
				}
				{
				edit_tradeNoVat ?
					<td style={{'width':`${sdata.col_7}%`}}><input onChange={ (event) => onChangeHandler(event,setEditTradeNoVat)} className={SETTINGS.input_classes} value={tradeNoVat}></input></td>
					:<td style={{'width':`${sdata.col_7}%`}} onClick={ () => { onClickHandler(setEditTradeNoVat)} } >£{tradeNoVat}</td>
				}
			</tr>
		</>
	)
