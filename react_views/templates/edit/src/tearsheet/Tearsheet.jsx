...
export default function Tearsheet() {
  ...
  return(
			<div className="flex justify-center items-center grid grid-cols-[850px_auto] gap-5">

				<div className="grid-item__wrapper">
					<div style={{ 'line-height': '1.5', 'font-weight': '400', 'letter-spacing': '.05em', 'font-size': `${sdata.font_size}px`, 'position':'relative', 'width':'850px','height':'1100px', }} className="rounded-lg ">
